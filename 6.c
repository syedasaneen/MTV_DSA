/*6. Develop a menu driven Program in C for the following operations on Doubly Linked List
...
Employee *head = NULL;
/ Function to create a new node using the Structure Employee as data type to 
/return function.
Employee *createNode()
{
